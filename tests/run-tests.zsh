...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║           OSA CLI Tests - Running Test Suite               ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo ""
...
if bats "$TESTS_DIR"/*.bats; then
  ...
  echo "  • CLI argument parsing and flag handling"
  echo "  • Flag interaction and precedence"
  echo "  • clean_all function safety checks"
  echo "  • Symlink detection and backup behavior"
